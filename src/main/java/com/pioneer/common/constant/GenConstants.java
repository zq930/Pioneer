...
public interface GenConstants {
     ...
     * 页面不需要编辑字段
     */
    String[] COLUMN_NAME_NOT_EDIT = {"id", "create_by", "create_time", "del_flag"};

    /**
     * 页面不需要显示的列表字段
     */
    String[] COLUMN_NAME_NOT_LIST = {"id", "create_by", "create_time", "del_flag", "update_by",
            "update_time"};
